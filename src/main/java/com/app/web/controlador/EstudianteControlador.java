...
public class EstudianteControlador {
	...
	public String mostrarFormularioDeEditar(@PathVariable String id, Model modelo) {
		modelo.addAttribute("estudiante", servicio.obtenerEstudiantePorId(id));
		return "editar_estudiante";
	}

	@PostMapping("/estudiantes/{id}")
	public String actualizarEstudiante(@PathVariable String id, @ModelAttribute("estudiante") Estudiante estudiante,
			Model modelo) {
